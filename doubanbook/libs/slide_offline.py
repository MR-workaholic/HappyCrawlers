...
def md5(a):
    def b(a, b):
        return a << b | zero_fill_right_shit(a, 32-b)
    ...
    def l(a):
        ...
        g[b] = g[b] | 128 << h
        g[f-2] = c << 3
        g.append(zero_fill_right_shit(c, 29))
        return g

    def m(a):
        d, e = "", ""
        for c in range(0, 4):
            b = zero_fill_right_shit(a, 8*c) & 255
            e = '0' + '{0:x}'.format(b)
            d += e[-2:]
        return d
    ...
    def n(a):
        ...
        return b
    x, y, z = [], 7, 12
    A, B, C, D, E = 17, 22, 5, 9, 14
    F, G, H, I, J = 20, 4, 11, 16, 23
    K, L, M, N = 6, 10, 15, 21
    a = n(a)
    x = l(a)
    t = 1732584193
...
def ajax(challenge):
    rand0, rand1 = int(6 * random()), int(300 * random())
    x_pos = get_x_pos(rand0, rand1)
    # x_pos, rand0, rand1 = 189, 3, 115
    validate = ra(x_pos, challenge) + '_' + ra(rand0, challenge) + '_' + ra(rand1, challenge)
    return validate

if __name__ == '__main__':
    print ajax("a1d0c6e83f027327d8461063f4ac58a614")
    # print ra(75, '67c6a1e7ce56d3d6fa748ab6d9af3fd772')
    # print get_x_pos(1, 149)

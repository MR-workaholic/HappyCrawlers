...
class MyProxyMiddleware(object):  # 该为指定代理，暂未使用
    IPPOOL = [
        {
            "host": "180.106.13.100",
            "password": "public",
        ...
        {
            "host": "180.106.106.158",
            "password": "public",
            "port": "8888",
            "user": "adsl"
        },
        {
            "host": "221.225.199.160",
            "password": "public",
            "port": "8888",
            "user": "adsl"
        },
    ...
    def process_request(self, request, spider):
        ...
        proxy_user_pass = ip['user'] + ":" + ip['password']
...
class RotateUserAgentMiddleware(UserAgentMiddleware):  # 轮换代理agent
    ...
    def process_request(self, request, spider):
        ...
        if ua:
            ...
            # the default user_agent_list composes chrome,I E,firefox,
